import * as Res from './ootw.js';
import { SfxPlayer } from './sound.js';
...
function inIntro() {
  return !next_part && current_part !== 16002;
}
...
function heroPosFaceRight() {
  return vars[VAR_HERO_POS_LEFT_RIGHT] === 1;
}
