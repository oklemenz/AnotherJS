...
export const PALETTE_EGA = [
  0x00, 0x00, 0x00, 0x00, 0x00, 0xaa, 0x00, 0xaa, 0x00, 0x00, 0xaa, 0xaa, 0xaa, 0x00, 0x00, 0xaa, 0x00, 0xaa, 0xaa,
  0x55, 0x00, 0xaa, 0xaa, 0xaa, 0x55, 0x55, 0x55, 0x55, 0x55, 0xff, 0x55, 0xff, 0x55, 0x55, 0xff, 0xff, 0xff, 0x55,
  0x55, 0xff, 0x55, 0xff, 0xff, 0xff, 0x55, 0xff, 0xff, 0xff
];
...
export function set_palette_ega(offset) {
  for (let i = 0; i < 16; ++i) {
    ...
    palette32[PALETTE_TYPE.EGA * 16 + i] =
      0xff000000 | (PALETTE_EGA[color + 2] << 16) | (PALETTE_EGA[color + 1] << 8) | PALETTE_EGA[color];
  }
}
